 ...
 * @author Егор
 */
public class DahsboardForm extends javax.swing.JFrame {

    /**
     * Creates new form DahsboardForm
     */
    public DahsboardForm() {
     ...
     public void displayImage() {
        ...
        //set the image
        ImageIcon imgIco = new ImageIcon(getClass().getResource("/library_management_system/images/book_libr.png"));
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel_Dashboard_Logo, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DahsboardForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DahsboardForm().setVisible(true);
            }
        });
    }
